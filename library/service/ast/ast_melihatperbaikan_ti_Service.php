...
class ast_melihatperbaikan_ti_Service {
	...
	public function queryAjuanPerbaikantiByOrgTU($pageNumber, $itemPerPage, $stat, $unitkr) {
		$status=$stat;
		$registry = Zend_Registry::getInstance();
		$db = $registry->get('db');
		try {
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 {
				$result = $db->fetchAll("Select i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b 
										  where a.i_orgb like ?  and c_setuju_statussi is null
	...
	public function queryAjuanPerbaikantiByOrgPrnt($pageNumber, $itemPerPage, $stat, $unitkr) {
		$status=$stat;
		$registry = Zend_Registry::getInstance();
		$db = $registry->get('db');
		try {
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 if(($pageNumber==0) && ($itemPerPage==0))
			 {
				$result = $db->fetchAll("Select i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b 
										  where a.i_orgb = ?  and c_setuju_statussi is null
										  and a.i_orgb=b.i_orgb 
										  
										  UNION
										  Select i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b 
										  where i_orgb_parent = ?  and c_setuju_statussi is null
										  and a.i_orgb=b.i_orgb 
										  
										  UNION
										  Select i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm C 
										  where c_setuju_statussi is null  and a.i_orgb=C.i_orgb
											and exists ( select * 
											from e_org_0_0_tm  B
										  ...
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  FROM E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b 
										  where c_setuju_statussi is null and a.i_orgb=b.i_orgb
											and i_orgb_parent   
	...
	//===========================================persetujuan=====================================================
	public function queryPerbaikantiByOrgTU($pageNumber, $itemPerPage, $stat, $unitkr) {
		$status=$stat;
		$registry = Zend_Registry::getInstance();
		$db = $registry->get('db');
		try {
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 if(($pageNumber==0) && ($itemPerPage==0))
			 {
				$result = $db->fetchAll("Select a.i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  ...
										  where a.i_orgb like ?  and c_setuju_statussi = ? and c_status_perbaikan is null
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = d.i_barang_ajuanbaik
										  ",$where);
	...
	public function queryPerbaikantiByOrgPrnt($pageNumber, $itemPerPage, $stat, $unitkr) {
		$status=$stat;
		$registry = Zend_Registry::getInstance();
		$db = $registry->get('db');
		try {
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 if(($pageNumber==0) && ($itemPerPage==0))
			 {
				$result = $db->fetchAll("Select a.i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm d
										  where a.i_orgb = ?  and c_setuju_statussi = ? and c_status_perbaikan is null
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = d.i_barang_ajuanbaik
										  
										  UNION
										  Select a.i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm d
										  where i_orgb_parent = ?  and c_setuju_statussi = ? and c_status_perbaikan is null
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = d.i_barang_ajuanbaik
										  
										  UNION
										  Select a.i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm C , e_ast_ajuanbaikti_item_tm d
										  where c_setuju_statussi = ? and c_status_perbaikan is null
										  and a.i_orgb=c.i_orgb and a.i_barang_ajuanbaik = d.i_barang_ajuanbaik
										  and exists ( select * 
											from e_org_0_0_tm  B
											where B.i_orgb_parent  = ?
											         and B.i_orgb = C.i_orgb_parent
	...
	//==================penerimaan brg ti=================================================================================================================
	public function queryTerimaPerbaikantiByOrgTU($pageNumber, $itemPerPage, $unitkr) {
		//$status=$stat;
		$registry = Zend_Registry::getInstance();
		$db = $registry->get('db');
		try {
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 if(($pageNumber==0) && ($itemPerPage==0))
			 {
				$result = $db->fetchAll("Select i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b 
										  where a.i_orgb like ?  and i_barang_penerimaan is not null
										  and a.i_orgb=b.i_orgb 
										  ",$where);
	...
	public function queryTerimaPerbaikantiByOrgPrnt($pageNumber, $itemPerPage, $unitkr) {
		$status=$stat;
		$registry = Zend_Registry::getInstance();
		$db = $registry->get('db');
		try {
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 if(($pageNumber==0) && ($itemPerPage==0))
			 {
				$result = $db->fetchAll("Select i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b 
										  where a.i_orgb = ?  and i_barang_penerimaan is not null
										  and a.i_orgb=b.i_orgb 
										  ...
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b 
										  where i_orgb_parent = ?  and i_barang_penerimaan is not null
										  and a.i_orgb=b.i_orgb 
										  ...
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm C 
										  where i_barang_penerimaan is not null and a.i_orgb=C.i_orgb
											and exists ( select * 
											from e_org_0_0_tm  B
											where B.i_orgb_parent  = ?
											         and B.i_orgb = C.i_orgb_parent
										  ...
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  FROM E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b 
										  where i_barang_penerimaan is not null and a.i_orgb=b.i_orgb
											and i_orgb_parent   
													in ( select A.i_orgb from e_org_0_0_tm A
														 where exists 
													       ( select * from e_org_0_0_tm  B
	...
	//========================================= pengajuan  permintaan sparepart ================================================
	
	public function queryPengajuanSPartByOrgTU($pageNumber, $itemPerPage, $stat, $unitkr) {
		$status=$stat;
		$registry = Zend_Registry::getInstance();
		$db = $registry->get('db');
		try {
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 if(($pageNumber==0) && ($itemPerPage==0))
			 {
				$result = $db->fetchAll("Select a.i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm c
										  where a.i_orgb like ?  and c_setuju_sparepart is null and c_status_perbaikan = 'N' 
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = c.i_barang_ajuanbaik
										  ",$where);
			 ...
			 else
			 {
				 ...
				 $result = $db->fetchAll("Select a.i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb,
										  i_peg_helpdesk,e_tindakan_perbaikan,e_saran_sparepart
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm c
										  where a.i_orgb like ?  and c_setuju_sparepart is null and c_status_perbaikan = 'N'
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = c.i_barang_ajuanbaik
										  order by i_barang_ajuanbaik
	...
	public function queryPengajuanSPartByOrgPrnt($pageNumber, $itemPerPage, $stat, $unitkr) {
		$status=$stat;
		$registry = Zend_Registry::getInstance();
		$db = $registry->get('db');
		try {
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 if(($pageNumber==0) && ($itemPerPage==0))
			 {
				$result = $db->fetchAll("Select a.i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  ...
										  i_peg_helpdesk,e_tindakan_perbaikan,e_saran_sparepart
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm c
										  where a.i_orgb = ?  and c_setuju_sparepart is null and c_status_perbaikan = 'N'
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = c.i_barang_ajuanbaik
										  ...
										  i_peg_helpdesk,e_tindakan_perbaikan,e_saran_sparepart
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm c
										  where i_orgb_parent = ?  and c_setuju_sparepart is null and c_status_perbaikan = 'N'
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = c.i_barang_ajuanbaik
										  ...
										  i_peg_helpdesk,e_tindakan_perbaikan,e_saran_sparepart
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm C , e_ast_ajuanbaikti_item_tm d
										  where  c_setuju_sparepart is null and c_status_perbaikan = 'N'
										  and a.i_orgb=c.i_orgb and a.i_barang_ajuanbaik = d.i_barang_ajuanbaik
										  and exists ( select * 
											from e_org_0_0_tm  B
											where B.i_orgb_parent  = ?
	...
	//========================================= persetujuan permintaan sparepart ================================================
	
	public function queryPersetujuanSPartByOrgTU($pageNumber, $itemPerPage, $stat, $unitkr) {
		$status=$stat;
		$registry = Zend_Registry::getInstance();
		$db = $registry->get('db');
		try {
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 if(($pageNumber==0) && ($itemPerPage==0))
			 {
				$result = $db->fetchAll("Select a.i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm c
										  where a.i_orgb like ?  and c_setuju_sparepart = ? and c_terima_sparepart is null
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = c.i_barang_ajuanbaik
										  ",$where);
	...
	public function queryPersetujuanSPartByOrgPrnt($pageNumber, $itemPerPage, $stat, $unitkr) {
		$status=$stat;
		$registry = Zend_Registry::getInstance();
		$db = $registry->get('db');
		try {
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 if(($pageNumber==0) && ($itemPerPage==0))
			 {
				$result = $db->fetchAll("Select a.i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  ...
										  i_peg_helpdesk,e_tindakan_perbaikan,e_saran_sparepart
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm c
										  where a.i_orgb = ?  and c_setuju_sparepart = ? and c_terima_sparepart is null
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = c.i_barang_ajuanbaik
										  ...
										  i_peg_helpdesk,e_tindakan_perbaikan,e_saran_sparepart
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm c
										  where i_orgb_parent = ?  and c_setuju_sparepart = ? and c_terima_sparepart is null
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = c.i_barang_ajuanbaik
										  ...
										  i_peg_helpdesk,e_tindakan_perbaikan,e_saran_sparepart
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm C , e_ast_ajuanbaikti_item_tm d
										  where  c_setuju_sparepart = ? and c_terima_sparepart is null
										  and a.i_orgb=c.i_orgb and a.i_barang_ajuanbaik = d.i_barang_ajuanbaik
										  and exists ( select * 
											from e_org_0_0_tm  B
											where B.i_orgb_parent  = ?
	...
	//========================================= Selesai Perbaikan  ==============belum dikembalikan==================================
	
	public function querySelesaiPerbaikanByOrgTU($pageNumber, $itemPerPage, $stat, $unitkr) {
		$status='Y';
		$status2=$stat;
		$registry = Zend_Registry::getInstance();
		$db = $registry->get('db');
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 if(($pageNumber==0) && ($itemPerPage==0))
			 {
				$result = $db->fetchAll("Select a.i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm c
										  where a.i_orgb like ?  and c_status_perbaikan = ? and i_barang_pengembalian is null
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = c.i_barang_ajuanbaik
										  ",$where);
	...
	public function querySelesaiPerbaikanByOrgPrnt($pageNumber, $itemPerPage, $stat, $unitkr) {
		$status=$stat;
		$registry = Zend_Registry::getInstance();
		$db = $registry->get('db');
		try {
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 if(($pageNumber==0) && ($itemPerPage==0))
			 {
				$result = $db->fetchAll("Select a.i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  ...
										  i_peg_helpdesk,e_tindakan_perbaikan,e_saran_sparepart
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm c
										  where a.i_orgb = ?  and c_status_perbaikan = ? and i_barang_pengembalian is null 
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = c.i_barang_ajuanbaik
										  ...
										  i_peg_helpdesk,e_tindakan_perbaikan,e_saran_sparepart
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm c
										  where i_orgb_parent = ?  and c_status_perbaikan = ? and i_barang_pengembalian is null 
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = c.i_barang_ajuanbaik
										  ...
										  i_peg_helpdesk,e_tindakan_perbaikan,e_saran_sparepart
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm C , e_ast_ajuanbaikti_item_tm d
										  where  c_status_perbaikan = ? and i_barang_pengembalian is null 
										  and a.i_orgb=c.i_orgb and a.i_barang_ajuanbaik = d.i_barang_ajuanbaik
										  and exists ( select * 
											from e_org_0_0_tm  B
											where B.i_orgb_parent  = ?
	...
	public function querySelesaiPerbaikanSdhKembaliByOrgTU($pageNumber, $itemPerPage, $stat, $unitkr) {
		$status='Y';
		$status2=$stat;
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 if(($pageNumber==0) && ($itemPerPage==0))
			 {
				$result = $db->fetchAll("Select a.i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  d_anggaran,c_barang,i_aset,i_peg_nip,d_perolehan,e_barang_perbaikan,a.i_orgb,n_orgb 
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm c
										  where a.i_orgb like ?  and c_status_perbaikan = ? and i_barang_pengembalian is not null
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = c.i_barang_ajuanbaik
										  ",$where);
	...
	public function querySelesaiPerbaikanSdhKembaliByOrgPrnt($pageNumber, $itemPerPage, $stat, $unitkr) {
		$status=$stat;
		$registry = Zend_Registry::getInstance();
		$db = $registry->get('db');
		try {
			...
			$db->setFetchMode(Zend_Db::FETCH_OBJ); 
			 ...
			 if(($pageNumber==0) && ($itemPerPage==0))
			 {
				$result = $db->fetchAll("Select a.i_barang_ajuanbaik ,d_barang_ajuanbaik, 
										  ...
										  i_peg_helpdesk,e_tindakan_perbaikan,e_saran_sparepart
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm c
										  where a.i_orgb = ?  and c_status_perbaikan = ? and i_barang_pengembalian is not null 
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = c.i_barang_ajuanbaik
										  ...
										  i_peg_helpdesk,e_tindakan_perbaikan,e_saran_sparepart
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm b , e_ast_ajuanbaikti_item_tm c
										  where i_orgb_parent = ?  and c_status_perbaikan = ? and i_barang_pengembalian is not null 
										  and a.i_orgb=b.i_orgb and a.i_barang_ajuanbaik = c.i_barang_ajuanbaik
										  ...
										  i_peg_helpdesk,e_tindakan_perbaikan,e_saran_sparepart
										  from E_AST_AJUANBAIKTI_0_TM a, e_org_0_0_tm C , e_ast_ajuanbaikti_item_tm d
										  where  c_status_perbaikan = ? and i_barang_pengembalian is not null 
										  and a.i_orgb=c.i_orgb and a.i_barang_ajuanbaik = d.i_barang_ajuanbaik
										  and exists ( select * 
											from e_org_0_0_tm  B
											where B.i_orgb_parent  = ?
