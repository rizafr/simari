...
require_once('fpdf/color.inc.php');
require_once('fpdf/htmlparser.inc.php');
require_once('fpdf/fpdi.php');
class Ast_Pdf_Service extends FPDI {
...
function Ast_Pdf_Service($orientation='L',$unit='mm',$format='LETTER',$param_backgroud = null){
	parent::FPDF($orientation,$unit,$format);
	$this->SetMargins(20,20,20);
	$this->SetAuthor('Endri');
	$this->_makePageSize();
