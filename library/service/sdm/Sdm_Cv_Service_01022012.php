			...
			{		
				...
				$db->setFetchMode(Zend_Db::FETCH_OBJ);			
					$result = $db->fetchAll(" Select n_peg,n_peg_gelardepan,n_peg_gelarblkg,i_peg_nip,i_peg_nip_new,
											c_eselon,to_char(d_tmt_eselon,'dd-mm-yyyy') as d_tmt_eselon,
											...
											c_golongan_darah,n_peg_hobi,i_peg_karpeg
					...
					{ 
						...
						$nesl3 = $db->fetchOne(" SELECT n_unitkerja FROM sdm.tr_unitkerja WHERE c_eselon_iii='$c_eselon_iii' and c_eselon_ii='$c_eselon_ii' and c_tkt_esl='3' and c_lokasi_unitkerja='$c_lokasi_unitkerja'");
						$nesl4 = $db->fetchOne(" SELECT n_unitkerja FROM sdm.tr_unitkerja WHERE c_eselon_iv='$c_eselon_iv' and c_eselon_iii='$c_eselon_iii' and c_tkt_esl='4' and c_lokasi_unitkerja='$c_lokasi_unitkerja'");
						...
						$n_unit_kerja=$nesl4.$nesl3.$nesl2.$nesl1;
