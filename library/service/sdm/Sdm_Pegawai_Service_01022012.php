...
$n_eselon_i="";		
	...
	if ($c_eselon_i){
//	echo (string)$result[$j]->i_peg_nip."-".$c_eselon_i."<br>"; 
	...
	if ($c_eselon_ii){
//	echo (string)$result[$j]->i_peg_nip."-".$c_eselon_ii."<br>";
	...
	if ($c_eselon_iii){
//echo (string)$result[$j]->i_peg_nip."-".$c_eselon_iii."<br>";
	...
	if ($c_eselon_iv){
//	echo (string)$result[$j]->i_peg_nip."-".$c_eselon_iv."<br>";
	...
	public function maintainData(array $data,$par) {
	   ...
	   try {
		...
		if ($par=='update'){$db->update('sdm.tm_pegawai',$maintain_data, "i_peg_nip = '".trim($data['i_peg_nip'])."'  and c_stat_aktivasi = 'A' ");}	 
	...
	public function maintainHapusData($i_peg_nip,$i_entry) {
	   ...
	   try {
		...
		$db->update('sdm.tm_pegawai',$maintain_data, "i_peg_nip = '".trim($i_peg_nip)."'  and c_stat_aktivasi = 'A' ");
		$db->commit();
		return 'sukses';
	   } catch (Exception $e) {
         $db->rollBack();
				...
				$db->setFetchMode(Zend_Db::FETCH_OBJ);			
					...
					{ 
						...
						if ($c_lokasi_unitkerja_cpns=='1'){
							...
							$neseloncpns1 = $db->fetchOne(" SELECT n_unitkerja FROM sdm.tr_unitkerja WHERE c_eselon_i='$c_eselon_i_cpns' and c_tkt_esl='1' and c_lokasi_unitkerja='$c_lokasi_unitkerja_cpns'");
							$neseloncpns2 = $db->fetchOne(" SELECT n_unitkerja FROM sdm.tr_unitkerja WHERE c_eselon_i='$c_eselon_i_cpns' and c_eselon_ii='$c_eselon_ii_cpns' and  c_tkt_esl='2' and c_lokasi_unitkerja='$c_lokasi_unitkerja_cpns'");							
							$neseloncpns3 = $db->fetchOne(" SELECT n_unitkerja FROM sdm.tr_unitkerja WHERE c_eselon_i='$c_eselon_i_cpns'  and c_eselon_ii='$c_eselon_ii_cpns' and c_lokasi_unitkerja='$c_lokasi_unitkerja_cpns' and c_child!='0'");
							$neseloncpns4 = $db->fetchOne(" SELECT n_unitkerja FROM sdm.tr_unitkerja WHERE c_eselon_i='$c_eselon_i_cpns'  and c_eselon_ii='$c_eselon_ii_cpns' and c_eselon_iii='$c_eselon_iii_cpns' and c_eselon_iv='$c_eselon_iv_cpns' and c_tkt_esl in ('3','4') and c_lokasi_unitkerja='$c_lokasi_unitkerja_cpns'");
							$neseloncpns5 = "00";
					//echo " SELECT n_unitkerja FROM sdm.tr_unitkerja WHERE c_eselon_i='$c_eselon_i_cpns'  and c_eselon_ii='$c_eselon_ii_cpns' and c_eselon_iii='$c_eselon_iii_cpns' and c_eselon_iv='$c_eselon_iv_cpns' and c_tkt_esl in ('3','4') and c_lokasi_unitkerja='$c_lokasi_unitkerja_cpns'";		
