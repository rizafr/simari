			...
			try 
			{
				...
				$db->setFetchMode(Zend_Db::FETCH_OBJ);			
					$result = $db->fetchAll("SELECT i_peg_nip, n_peg,c_peg_status,c_eselon,to_char(d_tmt_eselon,'dd-mm-yyyy') as d_tmt_eselon,
								...
								FROM sdm.tm_pegawai where 1=1 $cari ORDER BY c_golongan ASC,d_tmt_golongan ASC,c_eselon ASC,q_tktfgs,d_tmt_eselon ASC,d_tmt_cpns asc, q_tahun ASC,c_pend ASC,d_pend_akhir ASC,d_peg_lahir ASC
								");
...
/* 				$n_eselon_ix = $db->fetchAll("select n_unitkerja,c_esl from sdm.tr_unitkerja where c_eselon_i='$c_eselon_i'");
				$n_eselon_i=trim($n_eselon_ix[0]->n_unitkerja);
				$c_esl_i=trim($n_eselon_ix[0]->c_esl);
				if ($n_eselon_i){$n_eselon_i=$this->cekNamaUk($n_eselon_i,$c_esl_i);$nesl1=",$n_eselon_i";}
		
				
				$n_eselon_iix = $db->fetchAll("select n_unitkerja,c_esl from sdm.tr_unitkerja where  c_eselon_ii='$c_eselon_ii'");
				$n_eselon_ii=trim($n_eselon_iix[0]->n_unitkerja);
				$c_esl_ii=trim($n_eselon_iix[0]->c_esl);
				if ($n_eselon_ii){$n_eselon_ii=$this->cekNamaUk($n_eselon_ii,$c_esl_ii);$nesl2=",$n_eselon_ii";}
				
				$n_eselon_iiix = $db->fetchAll("select n_unitkerja,c_esl from sdm.tr_unitkerja where  c_eselon_iii='$c_eselon_iii'");
				$n_eselon_iii=trim($n_eselon_iiix[0]->n_unitkerja);
				$c_esl_iii=trim($n_eselon_iiix[0]->c_esl);
				if ($n_eselon_iii){$n_eselon_iii=$this->cekNamaUk($n_eselon_iii,$c_esl_iii);$nesl3=",$n_eselon_iii";}				
				
				$n_eselon_ivx = $db->fetchAll("select n_unitkerja,c_esl from sdm.tr_unitkerja where  c_eselon_iv='$c_eselon_iv'");
				$n_eselon_iv=trim($n_eselon_ivx[0]->n_unitkerja);
				$c_esl_iv=trim($n_eselon_ivx[0]->c_esl);
				if ($n_eselon_iv){$n_eselon_iv=$this->cekNamaUk($n_eselon_iv,$c_esl_iv);$nesl4=",$n_eselon_iv";}				
				
				$n_eselon_vx = $db->fetchAll("select n_unitkerja,c_esl from sdm.tr_unitkerja where  c_eselon_v='$c_eselon_v'");
				$n_eselon_v=trim($n_eselon_vx[0]->n_unitkerja);
				$c_esl_v=trim($n_eselon_vx[0]->c_esl); */

				if ($c_eselon_i && $c_eselon_i!='' && $c_eselon_i!=' ' && $c_eselon_i!='00'){
				$n_eselon_ix = $db->fetchAll("select n_unitkerja,c_esl from sdm.tr_unitkerja where c_eselon_i='$c_eselon_i' and c_lokasi_unitkerja='$c_lokasi_unitkerja'");
				$n_eselon_i=trim($n_eselon_ix[0]->n_unitkerja);
				$c_esl_i=trim($n_eselon_ix[0]->c_esl);
				if ($n_eselon_i){$n_eselon_i=$this->cekNamaUk($n_eselon_i,$c_esl_i);$nesl1=",$n_eselon_i";}		
				}
				if ($c_eselon_ii && $c_eselon_ii!='' && $c_eselon_ii!=' ' && $c_eselon_ii!='00'){
				$n_eselon_iix = $db->fetchAll("select n_unitkerja,c_esl from sdm.tr_unitkerja where c_eselon_i='$c_eselon_i' and c_eselon_ii='$c_eselon_ii' and c_lokasi_unitkerja='$c_lokasi_unitkerja'");
				$n_eselon_ii=trim($n_eselon_iix[0]->n_unitkerja);
				$c_esl_ii=trim($n_eselon_iix[0]->c_esl);
				if ($n_eselon_ii){$n_eselon_ii=$this->cekNamaUk($n_eselon_ii,$c_esl_ii);$nesl2=",$n_eselon_ii";}
				}
				if ($c_eselon_iii && $c_eselon_iii!='' && $c_eselon_iii!=' ' && $c_eselon_iii!='00'){
				$n_eselon_iiix = $db->fetchAll("select n_unitkerja,c_esl from sdm.tr_unitkerja where c_eselon_i='$c_eselon_i' and c_eselon_ii='$c_eselon_ii' and c_eselon_iii='$c_eselon_iii' and c_lokasi_unitkerja='$c_lokasi_unitkerja' and c_jabatan is not null");
				$n_eselon_iii=trim($n_eselon_iiix[0]->n_unitkerja);
				$c_esl_iii=trim($n_eselon_iiix[0]->c_esl);
				if ($n_eselon_iii){ $n_eselon_iii=$this->cekNamaUk($n_eselon_iii,$c_esl_iii);$nesl3=",$n_eselon_iii";}				
				}
				if ($c_eselon_iv && $c_eselon_iv!='' && $c_eselon_iv!=' ' && $c_eselon_iv!='00'){
				$n_eselon_ivx = $db->fetchAll("select n_unitkerja,c_esl from sdm.tr_unitkerja where c_eselon_i='$c_eselon_i' and c_eselon_ii='$c_eselon_ii' and c_eselon_iii='$c_eselon_iii' and  c_eselon_iv='$c_eselon_iv' and c_lokasi_unitkerja='$c_lokasi_unitkerja'");
				$n_eselon_iv=trim($n_eselon_ivx[0]->n_unitkerja);
				$c_esl_iv=trim($n_eselon_ivx[0]->c_esl);
				if ($n_eselon_iv){$n_eselon_iv=$this->cekNamaUk($n_eselon_iv,$c_esl_iv);$nesl4=",$n_eselon_iv";}				
				}
				if ($c_eselon_v && $c_eselon_v!='' && $c_eselon_v!=' ' && $c_eselon_v!='00'){
				$n_eselon_vx = $db->fetchAll("select n_unitkerja,c_esl from sdm.tr_unitkerja where   c_eselon_i='$c_eselon_i' and c_eselon_ii='$c_eselon_ii' and c_eselon_iii='$c_eselon_iii' and  c_eselon_iv='$c_eselon_iv' and c_eselon_v='$c_eselon_v' and c_lokasi_unitkerja='$c_lokasi_unitkerja'");
				$n_eselon_v=trim($n_eselon_vx[0]->n_unitkerja);
				$c_esl_v=trim($n_eselon_vx[0]->c_esl);
				if ($n_eselon_v){$n_eselon_v=$this->cekNamaUk($n_eselon_v,$c_esl_v);$nesl5=",$n_eselon_v";}				
				//if ($n_jabatan){$jabatanlengkap=$n_jabatan." pada ".$nesl5.$nesl4.$nesl3.$nesl2.$nesl1;}
				
				}
				
				if ($n_eselon_v){$n_eselon_v=$this->cekNamaUk($n_eselon_v,$c_esl_v);$nesl5=",$n_eselon_v";}				
				//if ($n_jabatan){$jabatanlengkap=$n_jabatan." pada ".$nesl5.$nesl4.$nesl3.$nesl2.$nesl1;}
				if ($n_jabatan){$jabatanlengkap=$n_jabatan." pada ".$nesl4.$nesl3.$nesl2.$nesl1;}
				...
				$n_pangkat_cpns= $db->fetchOne("SELECT n_peg_pangkat FROM sdm.tr_golongan_pangkat WHERE c_peg_golongan ='$c_golongan_cpns' and  c_peg_tipegolongan ='$c_status_kepegawaian'");
				...
				$c_peg_propinsi_lahir=trim((string)$result[$j]->c_peg_propinsi_lahir);
				$n_peg_propinsi_lahir= $db->fetchOne("SELECT n_propinsi FROM sdm.tr_propinsi WHERE c_propinsi ='$c_peg_propinsi_lahir'");

				$a_peg_kota_lahir=trim((string)$result[$j]->a_peg_kota_lahir);
				...
				//echo "SELECT n_kabupaten FROM sdm.tr_kabupaten WHERE c_kabupaten ='$a_peg_kota_lahir' and c_propinsi ='$c_peg_propinsi_lahir'";
				...
				// if ($n_jabatan){$jabatanlengkap=$n_jabatan." pada ";
					// if ($n_eselon_i){$jabatanlengkap=$n_jabatan." pada ,".$n_eselon_i;}
					// if ($n_eselon_ii){$jabatanlengkap=$n_jabatan." pada ,".$n_eselon_ii.", ".$n_eselon_i;}
					// if ($n_eselon_iii){$jabatanlengkap=$n_jabatan." pada ,".$n_eselon_iii.", ".$n_eselon_ii.", ".$n_eselon_i;}
					// if ($n_eselon_iv){$jabatanlengkap=$n_jabatan." pada ,".$n_eselon_iv.", ".$n_eselon_iii.", ".$n_eselon_ii.", ".$n_eselon_i;}
					// if ($n_eselon_v){$jabatanlengkap=$n_jabatan." pada ,".$n_eselon_v.", ".$n_eselon_iv.", ".$n_eselon_iii.", ".$n_eselon_ii.", ".$n_eselon_i;}
					// }						
 	...
 	public function getPegawaiList($cari,$currentPage, $numToDisplay,$orderby) 
	{
			...
			{	
				...
				$db->setFetchMode(Zend_Db::FETCH_OBJ);	
			if($orderby  == '') $orderby =" ORDER BY c_golongan ASC,d_tmt_golongan ASC,c_eselon ASC,q_tktfgs,d_tmt_eselon ASC,d_tmt_cpns asc, q_tahun ASC,c_pend ASC,d_pend_akhir ASC,d_peg_lahir ASC";		
			$sql = "SELECT i_peg_nip, n_peg,c_peg_status,c_eselon,to_char(d_tmt_eselon,'yyyy-mm-dd') as d_tmt_eselon,
								c_jabatan,to_char(d_mulai_jabat,'dd-mm-yyyy') as d_mulai_jabat,c_peg_jeniskelamin,
								to_char(d_akhir_jabat,'dd-mm-yyyy') as d_akhir_jabat,c_golongan,to_char(d_tmt_golongan,'yyyy-mm-dd') as d_tmt_golongan ,v_gaji_pokok,
								c_lokasi_unitkerja,c_eselon_i,c_eselon_ii,c_eselon_iii,c_eselon_iv,c_eselon_v,c_gol_cpns,
								c_lokasi_unitkerja_cpns,c_eselon_cpns,e_file_photo,c_eselon_cpns,c_lokasi_unitkerja_cpns,c_eselon_i_cpns,
								c_eselon_ii_cpns,c_eselon_iii_cpns,c_eselon_iv_cpns,c_eselon_v_cpns,c_jabatan_cpns,
								i_peg_nip_new,c_status_kepegawaian,n_peg_gelardepan,n_peg_gelarblkg,c_agama,c_golongan_darah,
								c_peg_statusnikah,n_peg_hobi,to_char(d_peg_lahir,'yyyy-mm-dd') as d_peg_lahir,c_peg_propinsi_lahir,a_peg_kota_lahir,q_peg_tinggibdn,
								q_peg_beratbdn,n_peg_rambut,n_peg_btkmuka,n_peg_warnakulit,n_peg_cirikhas,a_peg_rumah,a_peg_rt,
								a_peg_rw,a_peg_kelurahan,a_peg_kecamatan,a_peg_kota,a_peg_propinsi,a_peg_kodepos,i_peg_telponrumah,
								i_peg_telponhp,i_peg_karpeg,i_peg_karis,i_peg_taspen,i_peg_korpri,i_peg_ktp,i_peg_askes,d_tmt_kerja,
								c_stat_aktivasi,q_masakerja_bulan,q_masakerja_tahun,c_jenis_naik,n_jabatan_nokode,c_pend_jenis,
...
/* 				$n_eselon_i = $db->fetchOne("select n_unitkerja from sdm.tr_unitkerja where c_eselon_i='$c_eselon_i' and c_lokasi_unitkerja='$c_lokasi_unitkerja'");
				$n_eselon_ii = $db->fetchOne("select n_unitkerja from sdm.tr_unitkerja where c_eselon_i='$c_eselon_i' and c_eselon_ii='$c_eselon_ii' and c_lokasi_unitkerja='$c_lokasi_unitkerja'");
				$n_eselon_iii = $db->fetchOne("select n_unitkerja from sdm.tr_unitkerja where c_eselon_i='$c_eselon_i' and c_eselon_ii='$c_eselon_ii' and c_eselon_iii='$c_eselon_iii' and c_lokasi_unitkerja='$c_lokasi_unitkerja'");
				$n_eselon_iv = $db->fetchOne("select n_unitkerja from sdm.tr_unitkerja where c_eselon_i='$c_eselon_i' and c_eselon_ii='$c_eselon_ii' and c_eselon_iii='$c_eselon_iii' and  c_eselon_iv='$c_eselon_iv' and c_lokasi_unitkerja='$c_lokasi_unitkerja'");
				$c_eselon_v = $db->fetchOne("select n_unitkerja from sdm.tr_unitkerja where   c_eselon_i='$c_eselon_i' and c_eselon_ii='$c_eselon_ii' and c_eselon_iii='$c_eselon_iii' and  c_eselon_iv='$c_eselon_iv' and c_eselon_v='$c_eselon_v' and c_lokasi_unitkerja='$c_lokasi_unitkerja'");
 */
				...
				$c_peg_propinsi_lahir22=trim((string)$result[$j]->c_peg_propinsi_lahir);
				$a_peg_kota_lahir=(string)$result[$j]->a_peg_kota_lahir;
				$a_peg_kota_lahir22=trim((string)$result[$j]->a_peg_kota_lahir);
				$n_peg_kota_lahir= $db->fetchOne("SELECT n_kabupaten FROM sdm.tr_kabupaten WHERE c_kabupaten ='$a_peg_kota_lahir22' and c_propinsi ='$c_peg_propinsi_lahir22'");
...
/* 						if ($n_jabatan){$jabatanlengkap=$n_jabatan." pada ";
				...
				// next golongan
				$c_golongan_next = $this->getcgolongannext($c_golongan);				
				$n_golongan_next= $db->fetchOne("SELECT n_peg_golongan FROM sdm.tr_golongan_pangkat WHERE c_peg_golongan ='$c_golongan_next' and c_peg_tipegolongan='$c_status_kepegawaian'");
				
			list($yeselon,$meselon,$deselon) = split ('-',$result[$j]->d_tmt_eselon);
			$d_tmt_eselon = "$deselon-$meselon-$yeselon";
			list($ygolongan,$mgolongan,$dgolongan) = split ('-',$result[$j]->d_tmt_golongan);
			$d_tmt_golongan = "$dgolongan-$mgolongan-$ygolongan";
			
			list($ylahir,$mlahir,$dlahir) = split ('-',$result[$j]->d_peg_lahir);
			$d_peg_lahir2 = "$dlahir-$mlahir-$ylahir";	
		$data[$j] = array("i_peg_nip"=>(string)$result[$j]->i_peg_nip,
						"n_peg"=>(string)$result[$j]->n_peg,
						"c_peg_status"=>(string)$result[$j]->c_peg_status,
						"usiabulan"=>$usiabulan,
						...
						"n_peg_statusnikah"=>$n_peg_statusnikah,
						"n_peg_hobi"=>(string)$result[$j]->n_peg_hobi,
						"d_peg_lahir"=>$d_peg_lahir2,
						"d_peg_lahir2"=>$d_peg_lahir2,
						"c_peg_propinsi_lahir"=>(string)$result[$j]->c_peg_propinsi_lahir,
						"n_peg_propinsi_lahir"=>$n_peg_propinsi_lahir,
						"n_peg_kota_lahir"=>$n_peg_kota_lahir,
						"a_peg_kota_lahir"=>(string)$result[$j]->a_peg_kota_lahir,
						...
						"n_peg_kota"=>(string)$result[$j]->n_peg_kota,
						"d_tmt_kgb"=>(string)$result[$j]->d_tmt_kgb,
						"q_usia_pensiun"=>(string)$result[$j]->q_usia_pensiun,
						"n_status_kepegawaian"=>$n_status_kepegawaian);
		}
			}							
			return $data;
	...
	{
				if ($c_golongan == '10') {$c_golongan_next='09';} 
				elseif ($c_golongan == '09') {$c_golongan_next='08';} 
				elseif ($c_golongan == '08') {$c_golongan_next='07';}
				elseif ($c_golongan == '07') {$c_golongan_next='06';}
  			        elseif ($c_golongan == '06') {$c_golongan_next='05';}
				elseif ($c_golongan == '05') {$c_golongan_next='04';}
				elseif ($c_golongan == '04') {$c_golongan_next='03';}
				elseif ($c_golongan == '03') {$c_golongan_next='02';}
				elseif ($c_golongan == '02') {$c_golongan_next='01';}
//				elseif ($c_golongan == '09') {$c_golongan_next='10';}
				else {	
					$c_golongan_next=$c_golongan*1-1;	
					if ($c_golongan=='14'){$c_golongan_next='11';}
				}	
...
//baru untuk monitoring jabatan
 	public function getUnitKerja($cari) 
	{
			...
			{		
				...
				$db->setFetchMode(Zend_Db::FETCH_OBJ);			
					$result = $db->fetchAll("SELECT c_lokasi_unitkerja,c_eselon_i,c_eselon_ii,c_eselon_iii,c_eselon_iv,c_eselon_v,c_satker,
								c_parent,c_child,n_unitkerja,c_jabatan
								FROM sdm.tr_unitkerja where n_unitkerja <>' -' $cari order by c_eselon_i,c_eselon_ii,c_eselon_iii,c_eselon_iv");
/* 
					echo "SELECT c_lokasi_unitkerja,c_eselon_i,c_eselon_ii,c_eselon_iii,c_eselon_iv,c_eselon_v,c_satker,
								c_parent,c_child,n_unitkerja,c_jabatan
								FROM sdm.tr_unitkerja where n_unitkerja <>' -' $cari order by c_eselon_i,c_eselon_ii,c_eselon_iii,c_eselon_iv";		
 */					$jmlResult = count($result);
					for ($j = 0; $j < $jmlResult; $j++) 
					{ 
						...
						$c_jabatan=(string)$result[$j]->c_jabatan;
						$n_jabatan = $db->fetchOne("select n_jabatan from sdm.tr_jabatan where c_jabatan='$c_jabatan' ");
						//$status=$db->fetchOne("select c_jabatan from sdm.tm_pegawai where c_jabatan='$c_jabatan' and c_eselon_i='$c_eselon_i' and c_eselon_ii='$c_eselon_ii' and c_eselon_iii='$c_eselon_iii' and c_eselon_iv='$c_eselon_iv'");
						$datpej=$db->fetchAll("select c_jabatan,i_peg_nip_new,n_peg from sdm.tm_pegawai where c_jabatan='$c_jabatan' and c_eselon_i='$c_eselon_i' and c_eselon_ii='$c_eselon_ii' and c_eselon_iii='$c_eselon_iii' and c_eselon_iv='$c_eselon_iv'");
						$i_peg_nip_new=$datpej[0]->i_peg_nip_new;
						$n_peg=$datpej[0]->n_peg;
						$status=$datpej[0]->c_jabatan;
						$data[$j] = array("n_unitkerja"=>(string)$result[$j]->n_unitkerja,
						"c_eselon_i"=>(string)$result[$j]->c_eselon_i,
						"c_eselon_ii"=>(string)$result[$j]->c_eselon_ii,
						"c_eselon_iii"=>(string)$result[$j]->c_eselon_iii,
						"c_eselon_iv"=>(string)$result[$j]->c_eselon_iv,
 	...
 	public function getPegawaiListByNipB($cari,$currentPage, $numToDisplay) 
	{
			$registry = Zend_Registry::getInstance();
			$db = $registry->get('db');
			try 
			...
			{	
				...
				$db->setFetchMode(Zend_Db::FETCH_OBJ);			
					$result = $db->fetchAll("SELECT i_peg_nip,i_peg_nip_new,n_peg,n_peg_gelardepan,n_peg_gelarblkg,c_peg_jeniskelamin,
										c_golongan,c_agama,c_golongan_darah,c_peg_statusnikah,n_peg_hobi,to_char(d_peg_lahir,'dd-mm-yyyy') as d_peg_lahir,c_peg_propinsi_lahir,
										a_peg_kota_lahir,q_peg_tinggibdn,q_peg_beratbdn,n_peg_rambut,n_peg_btkmuka,n_peg_warnakulit,
										n_peg_cirikhas,a_peg_rumah,a_peg_rt,a_peg_rw,a_peg_kelurahan,a_peg_kecamatan,a_peg_kota,
										a_peg_propinsi,a_peg_kodepos,i_peg_telponrumah,i_peg_telponhp,i_peg_karpeg,i_peg_karis,
										i_peg_taspen,i_peg_korpri,i_peg_ktp,i_peg_askes,e_file_photo,c_stat_aktivasi,
					...
					{ 
						...
						$n_pangkat= $db->fetchOne("SELECT n_peg_golongan FROM sdm.tr_golongan_pangkat WHERE c_peg_golongan ='$c_golongan' and c_peg_tipegolongan='$c_status_kepegawaian'");	
						//echo "SELECT n_peg_golongan FROM sdm.tr_golongan_pangkat WHERE c_peg_golongan ='$c_golongan' and c_peg_tipegolongan='$c_status_kepegawaian'";
						//exit();
						$c_gol_cpns=trim($result[$j]->c_gol_cpns);
						$n_pangkat_cpns= $db->fetchOne("SELECT n_peg_pangkat FROM sdm.tr_golongan_pangkat WHERE c_peg_golongan ='$c_gol_cpns' and c_peg_tipegolongan='$c_status_kepegawaian'");
...
if ($cesl=='01'){$data=str_replace("badan", "", $data);}
if ($cesl=='03'){$data=str_replace("biro", "", $data);}
if ($cesl=='03'){$data=str_replace("sub.", "", $data);}
if ($cesl=='03'){$data=str_replace("bagian", "", $data);}
if ($cesl=='03'){$data=str_replace("pengadilan", "", $data);}
if ($cesl=='04'){$data=str_replace("pengadilan", "", $data);}
if ($cesl=='05'){$data=str_replace("sub.", "", $data);}
if ($cesl=='05'){$data=str_replace("direktorat", "", $data);}
if ($cesl=='05'){$data=str_replace("biro", "", $data);}
if ($cesl=='07'){$data=str_replace("sub.", "", $data);}
if ($cesl=='07'){$data=str_replace("bidang", "", $data);}
if ($cesl=='07'){$data=str_replace("seksi", "", $data);}
if ($cesl=='08'){$data=str_replace("sub.", "", $data);}
if ($cesl=='08'){$data=str_replace("bidang.", "", $data);}
if ($cesl=='09'){$data=str_replace("urusan", "", $data);}
