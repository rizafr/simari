 ...
 //==================================================================================================================================
 	public function getTpmPegawai($cari) 
	{
			...
			try 
			{
				...
				$sql = "select tpm_id,a.id_list,usulan_id,peg_nip,a.tvinstansi_kd,tpm_keterangan, tpm_status,
							   tvinstansi_kd_l,ljabatangol_nm,tpm_jekel,tpm_tgllahir, tpm_namalengkap,lap_gol_tmt,
							   lap_gol_nm,lap_jab_l_nm,lap_jab_l_kelas,lap_jab_l_instan, lap_jab_b_nm,lap_jab_b_kelas,
							   lap_jab_b_instan,tpm_status_1,tpm_status_2,tpm_status_3,
						...
						from sdm.tm_pegawai_tpm a 
						where $cari  order by id_list desc";
					//echo $sql."<br>";
