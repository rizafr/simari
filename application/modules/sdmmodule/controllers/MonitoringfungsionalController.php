...
class Sdmmodule_MonitoringfungsionalController extends Zend_Controller_Action
{
	...
	public function monitoringfungsionaljsAction() 
	{
		header('content-type : text/javascript');
		$this->render('monitoringfungsionaljs');
	}
	public function monitoringfungsionalAction() 
	{
		$this->view->lokasiList = $this->reff_serv->getLokasi('');
		$this->view->statusGolRef = $this->reff_serv->getGolonganPegawai('');
		$this->view->jabatanRef = $this->reff_serv->getJabatan(" and c_eselon in('13','14') ");	    	
	}	
...
$html="";
	...
	// if ($blnawal){ $tgla ="01-$blnawal-$thnawal"; $tglb ="01-$blnawal-$thnakhir";
		...
		if ($jdllap){$html='<font face="Bookman Old Style, Book Antiqua, Garamond" size="2"><b>MONITORING JABATAN FUNGSIONAL<br>MAHKAMAH AGUNG</b></font>';}
		else{$html='<font face="Bookman Old Style, Book Antiqua, Garamond" size="2"><b>MONITORING JABATAN FUNGSIONAL<br>MAHKAMAH AGUNG</b></font>';}

$html=$html.'<div style="width: 1000px; height: 470px; overflow: auto; padding: 5px">';
$html=$html.' <table align="center" border="0" cellspacing="1" cellpadding="2" class="sortable">
		<tr>
			...
			<th><font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">GOL. RUANG & TMT</font></th>			
			<th><font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">JABATAN<br>TMT JABATAN</font></th>
			<th><font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">MASA KERJA</font></th>
			<th><font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">STATUS</font></th>
		</tr>
...
$html=$html.'
							...
							<td class="clleft" width="10%"><font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">'.$status.'</font></td>
							</tr>';				 
				}
			}	
	$html=$html.'</table></div>';
			...
			$d_tmt_kgb_baru	= "$d_tmt_golongan1-$d_tmt_golongan2-".(2 + $d_tmt_golongan3);
					...
					$html=$html.'<tr>';
					 $html=$html.'	<td  valign="top" align="left">
									...
									<td  valign="top" align="left" width="10%">'.$n_golongan.'<br>'.$d_tmt_golongan.'</td>';
							if ($jabatanlengkap){
 $html=$html.'								
...
$html=$html.'
							...
							<td  valign="top" align="left" width="10%">'.$masakerja.'</td>														
