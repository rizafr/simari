...
class Sdmmodule_DptigaController extends Zend_Controller_Action
{
	...
	public function dptigaAction() 
	{
		...
		if ($par=='insert'){
			...
			$par=$_GET['par'];
			$this->listDataByKey($_GET['i_peg_nip'],$_GET['d_peg_pnilai']);
...
public function hapusdataAction() {
		$MaintainData = array("i_peg_nip"=>$_GET['i_peg_nip'],
								"d_peg_pnilai"=>$_GET['d_peg_pnilai']);													
...
public function listDataByKey($i_peg_nip,$d_peg_pnilai) {
	
	$carilist = " and i_peg_nip='$i_peg_nip' and d_peg_pnilai='$d_peg_pnilai' ";
	...
	$this->view->n_jabatan_pnilai=$datadptiga[0]['n_jabatan_pnilai'];
	...
	$this->view->n_jabatan_atasanpnilai=$datadptiga[0]['n_jabatan_atasanpnilai'];
