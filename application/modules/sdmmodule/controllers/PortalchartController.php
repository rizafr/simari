...
private function golongan($par)
{
	...
	$jmlgol1 = $this->statistik_serv->getCountData(" $cari and c_golongan in ('20','21','22','23')  and(c_eselon !='17' or c_eselon isnull) ");
	$jmlgol2 = $this->statistik_serv->getCountData("$cari and c_golongan in ('14','15','16','17')  and(c_eselon !='17' or c_eselon isnull) ");
	$jmlgol3 = $this->statistik_serv->getCountData("$cari and c_golongan in ('08','09','10','11')  and(c_eselon !='17' or c_eselon isnull) ");
	$jmlgol4 = $this->statistik_serv->getCountData("$cari and c_golongan in ('03','04','05','06','07')  and(c_eselon !='17' or c_eselon isnull) ");	
	//$jmlkosong = $this->statistik_serv->getCountData("$cari and c_golongan isnull   and(c_eselon !='17' or c_eselon isnull) ");
	$jmlkosong =  $this->statistik_serv->getCountData("$cari and c_golongan not in('20','21','22','23','14','15','16','17','08','09','10','11','03','04','05','06','07') and(c_eselon !='17' or c_eselon isnull) ");
	$jmlkosong2 =  $this->statistik_serv->getCountData("$cari and c_golongan isnull and(c_eselon !='17' or c_eselon isnull) ");
	$jmlkosong3  =  $this->statistik_serv->getCountData("$cari and c_golongan =' '  and(c_eselon !='17' or c_eselon isnull) ");	
	...
	$this->view->jmlkosong=$jmlkosong*1+$jmlkosong2*1+$jmlkosong3*1;
	$this->view->totalgol=$jmlgol1*1+$jmlgol2*1+$jmlgol3*1+$jmlgol4*1+$jmlkosong*1+$jmlkosong2*1+$jmlkosong3*1;
	if($par=='b'){
...
function toChartGol($caption,$jmlgol1,$jmlgol2,$jmlgol3,$jmlgol4){
	...
	private function pendidikan($par)
	{
		...
		$jmlsd = $this->statistik_serv->getCountData(" $cari and c_pend ='29'   and(c_eselon !='17' or c_eselon isnull)");
		$jmlsmp = $this->statistik_serv->getCountData("$cari and c_pend ='41'   and(c_eselon !='17' or c_eselon isnull)");
		$jmlsma = $this->statistik_serv->getCountData("$cari and c_pend ='40'   and(c_eselon !='17' or c_eselon isnull)");
		$jmld1 = $this->statistik_serv->getCountData("$cari and c_pend ='04'   and(c_eselon !='17' or c_eselon isnull)");
		$jmld2 = $this->statistik_serv->getCountData("$cari and c_pend ='05'   and(c_eselon !='17' or c_eselon isnull)");
		$jmld3 = $this->statistik_serv->getCountData(" $cari and c_pend ='32'   and(c_eselon !='17' or c_eselon isnull)");
		$jmld4 = $this->statistik_serv->getCountData(" $cari and c_pend ='07'   and(c_eselon !='17' or c_eselon isnull)");
		$jmls1 = $this->statistik_serv->getCountData("$cari and c_pend ='36'   and(c_eselon !='17' or c_eselon isnull)");
		$jmls2 = $this->statistik_serv->getCountData("$cari and c_pend ='09'   and(c_eselon !='17' or c_eselon isnull)");
		$jmls3 = $this->statistik_serv->getCountData("$cari and c_pend ='10'   and(c_eselon !='17' or c_eselon isnull)");
		$jmlkosong =  $this->statistik_serv->getCountData("$cari and c_pend not in('29','41','40','04','05','32','07','36','09','10') and(c_eselon !='17' or c_eselon isnull) ");
		$jmlkosong2 =  $this->statistik_serv->getCountData("$cari and c_pend isnull and(c_eselon !='17' or c_eselon isnull) ");
		$jmlkosong3  =  $this->statistik_serv->getCountData("$cari and c_pend =' '  and(c_eselon !='17' or c_eselon isnull) ");
		...
		$this->view->jmlkosong=$jmlkosong*1+$jmlkosong2*1+$jmlkosong3*1;
		$this->view->totalpend=$jmlsd*1+$jmlsmp*1+$jmlsma*1+$jmld1*1+$jmld2*1+$jmld3*1+$jmld4*1+$jmls1*1+$jmls2*1+$jmls3*1+$jmlkosong*1+$jmlkosong2*1+$jmlkosong3*1;
		if ($par=='b'){
...
/* 			if ($jmlsd){$strXML .= "<set label=' SD' value='$jmlsd'  Color='0000FF' /> ";}			
	...
	private function usia($par) 
	{
		...
		$jml2635 = $this->statistik_serv->getCountData("$cari and ((EXTRACT(years from AGE(now(), d_peg_lahir))>= 26) and (EXTRACT(years from AGE(now(), d_peg_lahir))<= 35))   and(c_eselon !='17' or c_eselon isnull) ");
		$jml3645 = $this->statistik_serv->getCountData("$cari and ((EXTRACT(years from AGE(now(), d_peg_lahir))>= 36) and (EXTRACT(years from AGE(now(), d_peg_lahir))<= 45))   and(c_eselon !='17' or c_eselon isnull) ");
		$jml4655 = $this->statistik_serv->getCountData("$cari and ((EXTRACT(years from AGE(now(), d_peg_lahir))>= 46) and (EXTRACT(years from AGE(now(), d_peg_lahir))<= 55))    and(c_eselon !='17' or c_eselon isnull)");
		$jml56 = $this->statistik_serv->getCountData("$cari and (EXTRACT(years from AGE(now(), d_peg_lahir))>= 56)   and(c_eselon !='17' or c_eselon isnull) ");
		$jmlkosong = $this->statistik_serv->getCountData("$cari and d_peg_lahir isnull   and(c_eselon !='17' or c_eselon isnull) ");
		...
		$this->view->jmlkosong=$jmlkosong;
		$this->view->totalusia=$jml25*1+$jml2635*1+$jml3645*1+$jml4655*1+$jml56*1+$jmlkosong*1;
		if ($par=='b'){
...
public function viewAction() {
	...
	if ($mod=='pendidikan'){
		...
		if ($par=='sd'){$cari =" and c_pend ='29'";}
		if ($par=='smp'){$cari =" and c_pend ='41'";}
		if ($par=='sma'){$cari =" and c_pend ='40'";}
		if ($par=='d1'){$cari =" and c_pend ='04'";}
		if ($par=='d2'){$cari =" and c_pend ='05'";}
		if ($par=='d3'){$cari =" and c_pend ='32'";}
		if ($par=='d4'){$cari =" and c_pend ='07'";}
		if ($par=='s1'){$cari =" and c_pend ='36'";}
