...
public function tpmiiAction() {
	...
	if ($par=='insert'){
		...
		$usulan_id=$_GET['usulan_id'];
		$cari=" tpm_status_2 is not null and tpm_status_3 is null and b.usulan_id='$usulan_id' ";		
		$this->view->dataPraTpm= $this->tpm_serv->getTpmPegawai($cari);
		$this->listDataTpmList($usulan_id);	
...
public function daftartpmAction() {
	...
	$cari="  a.usulan_id=b.usulan_id and tpm_status_1=3 and tpm_status_2 is not null and tpm_status_3 is not null ";
