...
require_once "service/refferensi/Refdikmil_Service.php";

class Sdmmodule_RefdikmilController extends Zend_Controller_Action {
    ...
    public function init() {
  		...
  		$this->refjenjang_serv = Refdikmil_Service::getInstance();
...
public function insertjenjangAction(){
	...
	$this->view->proses 	= '1';
	$this->view->keterangan = 'Jenjang Dikmil';
