...
class Sdmmodule_StatistikagamaController extends Zend_Controller_Action
{
	...
	public function viewAction() 
	{
		...
		$jmlkosong =  $this->statistik_serv->getCountData("$cari and c_agama not in('13','14','15','12','11') ");
		$jmlkosong2 =  $this->statistik_serv->getCountData("$cari and c_agama isnull and(c_eselon !='17' or c_eselon isnull) ");
