...
$html=$html.' <table align="center" border="0" cellspacing="1" cellpadding="2" class="sortable">
		<tr>
			...
			<th colspan="2"><font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">MASA KERJA</font></th>
		...
		<tr>
			...
			<th><font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">JML.</font></th>
			<th><font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">NAMA</font></th>
	...
	if (count($pegawaiList)!=0){
		$noUrut=0;
			...
			for ($j = 0; $j < count($pegawaiList); $j++) 
				{
					$noUrut = (($currentPage -1)* $numToDisplay)+1+$j;
			...
			$d_tmt_kgb_baru	= "$d_tmt_golongan1-$d_tmt_golongan2-".(2 + $d_tmt_golongan3);
					...
					if ($j%2==0) {
					 ...
					 $html=$html.'	<td class="clleft" width="30%"><font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">'.$noUrut.'</font></td>
							...
							<td class="clleft" width="30%">
								<font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">'.$n_golongan.'</font>
							</td>
							<td class="clleft" width="30%">
								<font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">'.$d_tmt_golongan.'</font>
							</td>	
							<td class="clleft" width="30%">
								<font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">'.$n_jabatan.'</font>
							</td>
							<td class="clleft" width="30%">
								<font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">'.$d_mulai_jabat.'</font>
							</td>	
							<td class="clleft" width="30%">
								<font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">'.$masakerjatahun.'</font>
							</td>
							<td class="clleft" width="30%">
								<font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">'.$masakerjabulan.'</font>
							</td>							
							<td class="clleft" width="30%">
