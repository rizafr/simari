...
public function cetakviewAction(){
	 ...
	 if($s_nama)
	 {
		...
		if($_POST['y_lulus']){$cari= $cari." and to_char(d_sk_pns,'m') ='$y_lulus'";}
		...
		//if($_POST['y_diklatpim']){$cari= $cari." and c_penjenjangan =";} === blm ada di tabel
		//if($_POST['propinsi_unit']){$cari= $cari." and c_penjenjangan =";} === blm ada di tabel
		if($_POST['kd_jbt2']){$cari= $cari." and c_jabatan ='$kd_jbt2'";}
		//if($_POST['jabkelfungsional']){$cari= $cari." and c_penjenjangan =";} === blm ada di tabel
		if($_POST['d_tmt_jabatan']){$cari= $cari." and to_char(d_tmt_jabatan,'dd-mm-yyyy') ='$d_tmt_jabatan'";}
		...
		//if($_POST['usia_awl']){$cari= $cari." and c_penjenjangan =";}
		//if($_POST['usia_akh']){$cari= $cari." and c_penjenjangan =";}
		...
		if($_POST['a_kota_lahir']){$cari= $cari." and a_peg_kota_lahir ='$a_kota_lahir'";}
