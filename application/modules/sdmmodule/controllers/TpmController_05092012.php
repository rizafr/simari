...
public function listpratpmAction() {
	$cari=" usulan_id in (select usulan_id from sdm.tm_pegawai_tpm where (tpm_status_1 is not null and tpm_status_2 is not null and tpm_status_3 is not null) or (tpm_status_2 isnull and tpm_status_3 isnull)) ";	
...
if ($_POST['modul']=='pratpm')	
{
	...
	$cari="  usulan_id in (select usulan_id from sdm.tm_pegawai_tpm where tpm_status_2 isnull and tpm_status_3 isnull) ";	
	$this->view->dataPraTpm = $this->tpm_serv->getListTpm2($cari);
