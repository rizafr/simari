...
if ($jdllap){		
$html='<font face="Bookman Old Style, Book Antiqua, Garamond" size="2"><b>DAFTAR URUT KEPANGKATAN TAHUN '.$_POST['tahun'].' <br>'.$jdllap.'<br>MAHKAMAH AGUNG</b></font>';
}
else{
$html='<font face="Bookman Old Style, Book Antiqua, Garamond" size="2"><b>DAFTAR URUT KEPANGKATAN TAHUN '.$_POST['tahun'].' <br>MAHKAMAH AGUNG</b></font>';
}
