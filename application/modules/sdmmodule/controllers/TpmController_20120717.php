...
public function listpratpmAction() {
	...
	$cari=" a.usulan_id=b.usulan_id and tpm_status_2 isnull and tpm_status_3 isnull ";	
...
public function tpmiAction() {
	...
	if ($par=='insert'){
		...
		$cari="  a.usulan_id=b.usulan_id and tpm_status_1=3 and tpm_status_2 isnull and tpm_status_3 isnull and a.usulan_id='$usulan_id' ";
		$this->view->dataPraTpm= $this->tpm_serv->getTpmPegawai($cari);
		$this->listDataTpmList($usulan_id);		
...
$cari=" a.usulan_id=b.usulan_id and tpm_status_2 = 3 and tpm_status_3 isnull ";
$this->view->dataPraTpm = $this->tpm_serv->getListTpm2($cari);
}
...
public function listtpmiiAction() {
	...
	if ($usulan_id){
		...
		$cari="  a.usulan_id=b.usulan_id and tpm_status_1 is not null and tpm_status_2 is not null and tpm_status_3 is not null ";
	}
...
public function tpmiiAction() {
	...
	if ($par=='insert'){
		...
		$cari=" tpm_status_1=3 and tpm_status_2=3 and tpm_status_3 isnull and a.usulan_id='$usulan_id' ";
		$this->view->dataPraTpm= $this->tpm_serv->getTpmPegawai($cari);
		$this->listDataTpmList($usulan_id);		
		...
		$cari=" tpm_status_2 = 3 and tpm_status_3 is null and a.usulan_id='$usulan_id' ";		
		$this->view->dataPraTpm= $this->tpm_serv->getTpmPegawai($cari);
		$this->listDataTpmList($usulan_id);	
...
if ($_POST['modul']=='tpmi')	{
	$cari=" a.usulan_id=b.usulan_id and tpm_status_1=3 and tpm_status_2 is not null and tpm_status_3 isnull ";	
	$this->view->dataPraTpm = $this->tpm_serv->getListTpm2($cari);
	$this->render('listtpmi');
}
if ($_POST['modul']=='tpmii')	{
	$cari=" a.usulan_id=b.usulan_id and tpm_status_1=3 and tpm_status_2 = 3 and tpm_status_3 is not null ";	
	$this->view->dataPraTpm = $this->tpm_serv->getListTpm2($cari);
...
public function daftartpmAction() {
	...
	$cari="  a.usulan_id=b.usulan_id and tpm_status_1=3 and tpm_status_2 = 3 and tpm_status_3 = 3 ";
