...
/* 		if  ($_GET['eseloni'])
		...
		$this->view->chart=$this->toChart($_GET['par'],$jmllaki,$jmlwanita);

/* 		if ($c_lokasi_unitkerja){
		$this->view->judul= "Statistik Pegawai Menurut Jenis Kelamin di Tahun $tahun di $unitkerja pada, $jdlesi, $jdlesii, $jdlesiii, $jdlesiv"; 
		}
		else{
		$this->view->judul= "Statistik Pegawai Menurut Jenis Kelamin di Tahun $tahun di Mahkamah Agung"; 
		} */
		if ($unitkerja){
		...
		$this->view->judul= "Statistik Pegawai Menurut Jenis Kelamin di Tahun $tahun <br>di $unitkerja pada, $jd"; 
		}
		else{
		$this->view->judul= "Statistik Pegawai Menurut Jenis Kelamin di Tahun $tahun di Mahkamah Agung"; 
		}			
...
function toChart($par,$jmllaki,$jmlwanita){

				require_once "../library/fusionchart/FusionCharts.php";
				$fusionCharts = new fusionChart();
				$w='80%'; 
				$h='100%';
		$strXML = "<chart caption='$caption' xAxisName='Jenis Kelamin' yAxisName='' showValues='100'  showBorder='3'
		bgColor='999999,FFFFFF' bgAlpha='10' palette='2' animation='1' numberPrefix='1' pieSliceDepth='10' startingAngle='100' 
