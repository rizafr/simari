...
/* 	if ($neselon1){$nesl1=",$neselon1";}
	...
	if ($neselon4){$nesl4="$neselon4"; if($neselon5){$nesl4=$nesl4.",";} }
	if ($neselon3){$nesl3="$neselon3"; if($neselon4){$nesl3=$nesl3.",";} }
	if ($neselon2){$nesl2="$neselon2"; if($neselon3){$nesl2=$nesl2.",";} }
	if ($neselon1){$nesl1="$neselon1";}
	...
	$this->view->c_eselon_iii=trim($datapegawai[0]['ceselon2']).";".trim($datapegawai[0]['c_eselon_iii']).";".trim($datapegawai[0]['c_satker']).";".trim($datapegawai[0]['neselon3']);
	$this->view->c_eselon_iv=trim($datapegawai[0]['c_eselon_iv']).";".trim($datapegawai[0]['neselon4']);
