...
$html='<center><font face="Bookman Old Style, Book Antiqua, Garamond" size="2">PROYEKSI PENSIUN PADA TAHUN  '.$_POST['thnawal'].'<br>LINGKUP '.strtoupper($jdlesl).'</font></center>';
				...
				$tmtbaru	= "01-$m_tglnext-".($y_tgl+$q_usia_pensiun);
					...
					if ($j%2==0) {
					 ...
					 $html=$html.'	<td class="clleft" width="30%"><font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">'.$n_peg.'</font></td>
							...
							<td class="clcenter"><font face="Bookman Old Style, Book Antiqua, Garamond" size="1.5">'.$tmtbaru.'</font></td>
							</tr>';				 
				}
			}	
	$html=$html.'</table>';
