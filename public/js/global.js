...
function jumpto8(handler,totalPages,fungsi,param1,param2,param3,param4,param5,param6,param7,param8,param9,param10){
	var jump_page = window.prompt("Masukkan no halaman yang ingin Anda tuju:");
	totalPages = totalPages*1;
	var currentPage = jump_page*1;
...
function gantinewPage8(modul,fungsi,currentPage,param1,param2,param3,param4,param5,param6,param7,param8,param9,param10)
{
